...
É importante que saber que quando colocamos a direção `column`, os eixos terão um comportamento um pouco diferente. Com o valor 'column', a main axis será de cima para baixo, e a cross será da esquerda 
